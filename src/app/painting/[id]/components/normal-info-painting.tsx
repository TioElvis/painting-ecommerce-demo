  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <section className="w-full flex items-center justify-center">
        <div className="w-xl h-140 flex flex-col justify-between bg-background/20 backdrop-blur-3xl rounded-l-lg p-4 text-white">
          <div>
        ...
        <div className="w-xl h-140 relative">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            id="card-image"
            src={painting.image}
            alt={painting.title}
            className="w-xl h-180 absolute rounded-lg -top-20"
          />
        </div>
      </section>
    </div>

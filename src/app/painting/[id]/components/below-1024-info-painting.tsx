  ...
  return (
    <div className="w-full h-full flex items-center justify-center py-4 md:py-8 lg:py-12">
      <section className="w-full md:w-lg h-full flex flex-col items-center justify-center">
        ...
        <div className="h-80 text-white bg-background/20 backdrop-blur-3xl rounded-b-lg p-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between">
              <h2 className="text-4xl font-bold">{painting.title}</h2>
